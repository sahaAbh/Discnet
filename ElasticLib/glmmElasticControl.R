glmmElasticControl<-function(nue=1,index=NULL,smooth=NULL,start=NULL,int_start=NULL,q_start=NULL,center=TRUE,standardize=TRUE,  
...
{                       
  ...
  list(nue = nue, index=index, smooth = smooth,start = start, int_start=int_start,q_start = q_start, center=center, standardize = standardize,
